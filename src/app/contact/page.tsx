...
const socialLinks = [
  { icon: FacebookIcon, label: "Facebook", href: "https://www.facebook.com/share/1BD34XjDaF/" },
  { icon: Instagram, label: "Instagram", href: "https://www.instagram.com/the_integrityman_network" },
  { icon: Youtube, label: "YouTube", href: "https://youtube.com/@theintegritymannetwork" },
  { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/company/theintegrityman-network/" },
];
